...
#pragma warning restore
        ...
        void ShowToolbar() {
            ...
            if ( GUILayout.Button(string.Format("SLATE v{0}", Cutscene.VERSION_NUMBER.ToString("0.00")), EditorStyles.toolbarButton) ) {
        ...
        void ShowWelcome() {
            ...
            GUI.color = Color.white.WithAlpha(0.5f);
            GUILayout.Label("© 2016-2023 Paradox Notion. All rights reserved.");
            GUI.color = Color.white;
